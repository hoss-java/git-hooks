...
> - [x] 5. Add a new method to predicate args/params (will be used by `git-deck-completion`)
...
## 001-0005
> **Connect git-deck and git hooks message.** ![status](https://img.shields.io/badge/status-DONE-brightgreen)
> <details >
>     <summary>Details</summary>
> 
